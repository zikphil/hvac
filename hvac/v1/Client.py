...
from hvac import adapters, sync_api, aws_utils, exceptions, utils
...
class Client:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._auth = sync_api.AuthMethods(adapter=self._adapter)
        self._secrets = sync_api.SecretsEngines(adapter=self._adapter)
        self._sys = sync_api.SystemBackend(adapter=self._adapter)
    ...
    @property
    def auth(self):
        """Accessor for the Client instance's auth methods. Provided via the :py:class:`hvac.sync_api.AuthMethods` class.
        :return: This Client instance's associated Auth instance.
        :rtype: hvac.sync_api.AuthMethods
        """
        return self._auth

    @property
    def secrets(self):
        """Accessor for the Client instance's secrets engines. Provided via the :py:class:`hvac.sync_api.SecretsEngines` class.
        :return: This Client instance's associated SecretsEngines instance.
        :rtype: hvac.sync_api.SecretsEngines
        """
    ...
    def sys(self):
        ...
        Provided via the :py:class:`hvac.sync_api.SystemBackend` class.
        :return: This Client instance's associated SystemBackend instance.
        :rtype: hvac.sync_api.SystemBackend
        """
        return self._sys
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.auth_methods.Token.revoke_self,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.create,
    )
    def create_token(
        self,
        role=None,
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.renew_self,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.create_or_update_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.read_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.delete_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Token.list_roles,
    )
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.auth_methods.Cert.login,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.login,
    )
    def auth_userpass(
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.auth_methods.Aws.iam_login,
    )
    def auth_aws_iam(
        self,
        access_key,
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.ec2_login,
    )
    def auth_ec2(
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.create_or_update_user,
    )
    def create_userpass(
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.list_user,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.read_user,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.update_password_on_user,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Userpass.delete_user,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.configure,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.read_config,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.delete_config,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.create_certificate_configuration,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.read_certificate_configuration,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.list_certificate_configurations,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.create_role,
    )
    def create_ec2_role(
        self,
        role,
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.read_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.delete_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.list_roles,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=sync_api.auth_methods.Aws.create_role_tags,
    )
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.auth_methods.AppRole.create_or_update_approle,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.delete_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.list_roles,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.read_role_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.update_role_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.read_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.generate_secret_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.read_secret_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.list_secret_id_accessors,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.read_secret_id_accessor,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.destroy_secret_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.destroy_secret_id_accessor,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.create_custom_secret_id,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=sync_api.auth_methods.AppRole.login,
    )
    def auth_approle(
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.configure,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.read_config,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.create_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.read_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.list_roles,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.delete_role,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=sync_api.auth_methods.Kubernetes.login,
    )
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.secrets_engines.Transit.create_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.read_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.list_keys,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.delete_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.update_key_configuration,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.rotate_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.export_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.encrypt_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.decrypt_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.rewrap_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.generate_data_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.generate_random_bytes,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.hash_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.generate_hmac,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.sign_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.secrets_engines.Transit.verify_signed_data,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.unwrap,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.list_policies,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.create_or_update_policy,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.delete_policy,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.is_sealed,
    )
    def is_sealed(self):
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.seal,
    )
    def seal(self):
        self.sys.seal()
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.submit_unseal_key,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.submit_unseal_keys,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.list_mounted_secrets_engines,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.enable_secrets_engine,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.tune_mount_configuration,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.read_mount_configuration,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.disable_secrets_engine,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.move_backend,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.read_lease,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.renew_lease,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.revoke_lease,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.rotate_encryption_key,
    )
    def rotate(self):
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.start_rekey,
    )
    def start_rekey(
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.cancel_rekey,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.rekey,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.rekey_multi,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.read_backup_keys,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.is_initialized,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.initialize,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.start_root_token_generation,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.generate_root,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.cancel_root_generation,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.list_auth_methods,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.enable_auth_method,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.tune_auth_method,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.read_auth_method_tuning,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.disable_auth_method,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.list_enabled_audit_devices,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.enable_audit_device,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.disable_audit_device,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.SystemBackend.calculate_hash,
    )
    ...
    @utils.deprecated_method(
        ...
        new_method=sync_api.auth_methods.Ldap.login,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=sync_api.auth_methods.Gcp.login,
    )
    ...
    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=sync_api.auth_methods.Github.login,
    )
