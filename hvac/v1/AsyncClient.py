...
from hvac import api, aws_utils, exceptions, utils, async_adapters
...
class AsyncClient:
    ...
    def __init__(
        ...
        session=None,
        adapter=async_adapters.JSONAsyncAdapter,
        namespace=None,
        **kwargs,
    ):
        ...
        :param adapter: Optional class to be used for performing requests. If none is provided, defaults to
            hvac.async_adapters.JSONAsyncAdapter
    ...
    async def write(self, path, wrap_ttl=None, **kwargs):
        ...
        :rtype:
        """
        return await self._adapter.post(f"/v1/{path}", json=kwargs, wrap_ttl=wrap_ttl)
    ...
    async def get_policy(self, name, parse=False):
        ...
        """
        try:
            policy_req = await self.sys.read_policy(name=name)
            policy = policy_req["data"]["rules"]
        except exceptions.InvalidPath:
            return None
    ...
    async def revoke_self_token(self):
        """PUT /auth/token/revoke-self

        :return:
        :rtype:
        """
        await self._adapter.put("/v1/auth/token/revoke-self")
    ...
    async def revoke_token(self, token, orphan=False, accessor=False):
    ...
    async def revoke_token_prefix(self, prefix):
        ...
        :rtype:
        """
        await self._adapter.post(f"/v1/auth/token/revoke-prefix/{prefix}")
    ...
    async def renew_token(self, token=None, increment=None, wrap_ttl=None):
        ...
        if token is not None:
            ...
            return await self.renew_self_token(increment=increment, wrap_ttl=wrap_ttl)

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Token.renew_self,
    )
    async def renew_self_token(self, increment=None, wrap_ttl=None):
        """
        POST /auth/token/renew-self
    ...
    async def create_token_role(
        ...
        return await self._adapter.post(f"/v1/auth/token/roles/{role}", json=params)

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Token.read_role,
    )
    async def token_role(self, role):
        ...
        :rtype:
        """
        return await self.read(f"auth/token/roles/{role}")

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Token.delete_role,
    )
    async def delete_token_role(self, role):
        ...
        :rtype:
        """
        return await self.delete(f"auth/token/roles/{role}")

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Token.list_roles,
    )
    async def list_token_roles(self):
        """GET /auth/token/roles?list=true

        :return:
        :rtype:
        """
        return await self.list("auth/token/roles")
    ...
    async def auth_app_id(self, app_id, user_id, mount_point="app-id", use_token=True):
    ...
    async def auth_tls(self, mount_point="cert", use_token=True):
        """POST /auth/<mount point>/login
        ...
        :rtype:
        """
        return await self.auth.cert.login(mount_point=mount_point, use_token=use_token)

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Userpass.login,
    )
    async def auth_userpass(
    ...
    async def read_userpass(self, username, mount_point="userpass"):
        ...
        :rtype:
        """
        return await self._adapter.get(f"/v1/auth/{mount_point}/users/{username}")

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Userpass.create_or_update_user,
    )
    async def update_userpass_policies(self, username, policies, mount_point="userpass"):
    ...
    async def update_userpass_password(self, username, password, mount_point="userpass"):
    ...
    async def delete_userpass(self, username, mount_point="userpass"):
        ...
        :rtype:
        """
        return await self._adapter.delete(f"/v1/auth/{mount_point}/users/{username}")

    @utils.deprecated_method(to_be_removed_in_version="1.0.0")
    async def create_app_id(
    ...
    @utils.deprecated_method(to_be_removed_in_version="1.0.0")
    async def delete_app_id(self, app_id, mount_point="app-id"):
        ...
        :rtype:
        """
        return await self._adapter.delete(f"/v1/auth/{mount_point}/map/app-id/{app_id}")
    ...
    @utils.deprecated_method(to_be_removed_in_version="1.0.0")
    async def delete_user_id(self, user_id, mount_point="app-id"):
        ...
        :rtype:
        """
        return await self._adapter.delete(f"/v1/auth/{mount_point}/map/user-id/{user_id}")

    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=api.auth_methods.Aws.configure,
    )
    async def create_vault_ec2_client_configuration(
        ...
        return await self._adapter.post(f"/v1/auth/{mount_point}/config/client", json=params)
    ...
    async def get_vault_ec2_client_configuration(self, mount_point="aws-ec2"):
        ...
        :rtype:
        """
        return await self._adapter.get(f"/v1/auth/{mount_point}/config/client")

    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=api.auth_methods.Aws.delete_config,
    )
    async def delete_vault_ec2_client_configuration(self, mount_point="aws-ec2"):
        ...
        :rtype:
        """
        return await self._adapter.delete(f"/v1/auth/{mount_point}/config/client")

    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=api.auth_methods.Aws.create_certificate_configuration,
    )
    async def create_vault_ec2_certificate_configuration(
    ...
    async def create_ec2_role(
        ...
        return await self._adapter.post(f"/v1/auth/{mount_point}/role/{role}", json=params)
    ...
    async def get_ec2_role(self, role, mount_point="aws-ec2"):
        ...
        :rtype:
        """
        return await self._adapter.get(f"/v1/auth/{mount_point}/role/{role}")

    @utils.deprecated_method(
        to_be_removed_in_version="0.11.2",
        new_method=api.auth_methods.Aws.delete_role,
    )
    async def delete_ec2_role(self, role, mount_point="aws-ec2"):
        ...
        :rtype:
        """
        return await self._adapter.delete(f"/v1/auth/{mount_point}/role/{role}")
    ...
    async def auth_cubbyhole(self, token):
        """Perform a login request with a wrapped token.

        Stores the unwrapped token in the resulting Vault response for use by the :py:meth:`hvac.async_adapters.AsyncAdapter`
    ...
    async def login(self, url, use_token=True, **kwargs):
        ...
        Associated request is typically to a path prefixed with "/v1/auth") and optionally stores the client token sent
            in the resulting Vault response for use by the :py:meth:`hvac.async_adapters.AsyncAdapter` instance under the _adapater
            Client attribute.

        :param url: Path to send the authentication request to.
        :type url: str | unicode
        :param use_token: if True, uses the token in the response received from the auth request to set the "token"
            attribute on the the :py:meth:`hvac.async_adapters.AsyncAdapter` instance under the _adapater Client attribute.
        :type use_token: bool
    ...
    async def create_role(self, role_name, mount_point="approle", **kwargs):
    ...
    async def delete_role(self, role_name, mount_point="approle"):
        ...
        return await self._adapter.delete(f"/v1/auth/{mount_point}/role/{role_name}")
    ...
    async def list_roles(self, mount_point="approle"):
        ...
        return await self._adapter.get(f"/v1/auth/{mount_point}/role?list=true")
    ...
    async def get_role_id(self, role_name, mount_point="approle"):
        ...
        return await self._adapter.get(url)["data"]["role_id"]

    @utils.deprecated_method(
        to_be_removed_in_version="0.12.0",
        new_method=api.auth_methods.AppRole.update_role_id,
    )
    async def set_role_id(self, role_name, role_id, mount_point="approle"):
        ...
        return await self._adapter.post(url, json=params)
    ...
    async def get_role(self, role_name, mount_point="approle"):
        ...
        :rtype:
        """
        return await self._adapter.get(f"/v1/auth/{mount_point}/role/{role_name}")
    ...
    async def create_role_secret_id(
        ...
        return await self._adapter.post(url, json=params, wrap_ttl=wrap_ttl)
    ...
    async def list_role_secrets(self, role_name, mount_point="approle"):
        ...
        return await self._adapter.list(url)
    ...
    async def delete_role_secret_id(self, role_name, secret_id, mount_point="approle"):
    ...
    async def delete_role_secret_id_accessor(
        self, role_name, secret_id_accessor, mount_point="approle"
    ):
    ...
    async def create_kubernetes_configuration(
        self,
        kubernetes_host,
    ...
    async def get_kubernetes_configuration(self, mount_point="kubernetes"):
        ...
        url = f"/v1/auth/{mount_point}/config"
        return await self._adapter.get(url)
    ...
    async def delete_kubernetes_role(self, role, mount_point="kubernetes"):
        """DELETE /auth/<mount_point>/role/:role
        ...
        return await self._adapter.delete(url)

    @utils.deprecated_method(
        to_be_removed_in_version="1.0.0",
        new_method=api.auth_methods.Kubernetes.login,
    )
    async def auth_kubernetes(self, role, jwt, use_token=True, mount_point="kubernetes"):
        """POST /auth/<mount_point>/login
        ...
        return await self.login(url, json=params, use_token=use_token)

    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=api.secrets_engines.Transit.create_key,
    )
    async def transit_create_key(
        self,
        name,
    ...
    async def transit_delete_key(self, name, mount_point="transit"):
    ...
    async def transit_rotate_key(self, name, mount_point="transit"):
        ...
        return await self._adapter.post(url)
    ...
    async def unwrap(self, token=None):
        return await self.sys.unwrap(token=token)
    ...
    async def list_policies(self):
        policies =  await self.sys.list_policies()
    ...
    async def set_policy(self, name, rules):
        ...
        await self._adapter.put(api_path, json=params)
    ...
    async def delete_policy(self, name):
        await self.sys.delete_policy(name=name)
    ...
    async def is_sealed(self):
        return await self.sys.is_sealed()
    ...
    async def unseal_reset(self):
        return await self.sys.submit_unseal_key(reset=True)
    ...
    async def unseal(self, key):
        return await self.sys.submit_unseal_key(key=key)
    ...
    async def unseal_multi(self, keys):
        return await self.sys.submit_unseal_keys(keys=keys)
    ...
    async def list_secret_backends(self):
        return await self.sys.list_mounted_secrets_engines()

    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=api.SystemBackend.enable_secrets_engine,
    )
    async def enable_secret_backend(
        self,
        backend_type,
        description=None,
        mount_point=None,
        ...
        return await self.sys.enable_secrets_engine(
    ...
    async def tune_secret_backend(
        ...
        return await self.sys.tune_mount_configuration(
            path=mount_point,
    ...
    async def get_secret_backend_tuning(self, backend_type, mount_point=None):
        ...
        if not mount_point:
            mount_point = backend_type
        return await self.sys.read_mount_configuration(
            path=mount_point,
        )
    ...
    async def disable_secret_backend(self, mount_point):
        return await self.sys.disable_secrets_engine(
            path=mount_point,
        )
    ...
    async def remount_secret_backend(self, from_mount_point, to_mount_point):
        return await self.sys.move_backend(
    ...
    async def read_lease(self, lease_id):
        return await self.sys.read_lease(
            lease_id=lease_id,
        )
    ...
    async def renew_secret(self, lease_id, increment=None):
        return await self.sys.renew_lease(
            lease_id=lease_id,
            increment=increment,
        )
    ...
    async def revoke_secret(self, lease_id):
        return await self.sys.revoke_lease(
            lease_id=lease_id,
        )
    ...
    async def revoke_secret_prefix(self, path_prefix):
        await self.sys.revoke_prefix(
            prefix=path_prefix,
        )
    ...
    async def rotate(self):
        await self.sys.rotate_encryption_key()
    ...
    async def start_rekey(
        ...
        return await self.sys.start_rekey(
    ...
    async def cancel_rekey(self):
        return await self.sys.cancel_rekey()
    ...
    async def rekey_multi(self, keys, nonce=None):
        return await self.sys.rekey_multi(
            keys=keys,
            nonce=nonce,
        )
    ...
    async def get_backed_up_keys(self):
        return await self.sys.read_backup_keys()
    ...
    async def is_initialized(self):
        return await self.sys.is_initialized()
    ...
    async def initialize(self, secret_shares=5, secret_threshold=3, pgp_keys=None):
        return await self.sys.initialize(
            secret_shares=secret_shares,
            secret_threshold=secret_threshold,
            pgp_keys=pgp_keys,
        )
    ...
    async def start_generate_root(self, key, otp=False):
        ...
        if otp:
            ...
            params["pgp_key"] = key
        return await self.sys.start_root_token_generation(**params)
    ...
    async def generate_root(self, key, nonce):
        return await self.sys.generate_root(
            key=key,
            nonce=nonce,
        )
    ...
    async def cancel_generate_root(self):
        return await self.sys.cancel_root_generation().status_code == 204
    ...
    async def list_auth_backends(self):
        return await self.sys.list_auth_methods()

    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=api.SystemBackend.enable_auth_method,
    )
    async def enable_auth_backend(
        self,
        backend_type,
        description=None,
        mount_point=None,
        ...
        return await self.sys.enable_auth_method(
    ...
    async def tune_auth_backend(
        ...
        if not mount_point:
            mount_point = backend_type
        return await self.sys.tune_auth_method(
            path=mount_point,
            default_lease_ttl=default_lease_ttl,
            max_lease_ttl=max_lease_ttl,
            description=description,
    ...
    async def get_auth_backend_tuning(self, backend_type, mount_point=None):
        if not mount_point:
            mount_point = backend_type
        return await self.sys.read_auth_method_tuning(
            path=mount_point,
        )
    ...
    async def disable_auth_backend(self, mount_point):
        return await self.sys.disable_auth_method(
            path=mount_point,
        )
    ...
    async def list_audit_backends(self):
        return await self.sys.list_enabled_audit_devices()

    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=api.SystemBackend.enable_audit_device,
    )
    async def enable_audit_backend(
        self, backend_type, description=None, options=None, name=None
    ):
        await self.sys.enable_audit_device(
    ...
    async def disable_audit_backend(self, name):
        await self.sys.disable_audit_device(
            path=name,
        )
    ...
    async def audit_hash(self, name, input):
        return await self.sys.calculate_hash(
            path=name,
            input_to_hash=input,
        )
    ...
    async def auth_ldap(self, *args, **kwargs):
        return await self.auth.ldap.login(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.9.0",
        new_method=api.auth_methods.Gcp.login,
    )
    async def auth_gcp(self, *args, **kwargs):
        return await self.auth.gcp.login(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=api.auth_methods.Github.login,
    )
    async def auth_github(self, *args, **kwargs):
        return await self.auth.github.login(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.close,
    )
    async def close(self):
        return await self._adapter.close()

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.get,
    )
    async def _get(self, *args, **kwargs):
        return await self._adapter.get(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.post,
    )
    async def _post(self, *args, **kwargs):
        return await self._adapter.post(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.put,
    )
    async def _put(self, *args, **kwargs):
        return await self._adapter.put(*args, **kwargs)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.delete,
    )
    async def _delete(self, *args, **kwargs):
        return await self._adapter.delete(*args, **kwargs)

    @staticmethod
    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.urljoin,
    )
    def urljoin(*args):
        return async_adapters.Request.urljoin(*args)

    @utils.deprecated_method(
        to_be_removed_in_version="0.8.0",
        new_method=async_adapters.Request.request,
    )
    async def __request(self, *args, **kwargs):
        return await self._adapter.request(*args, **kwargs)
