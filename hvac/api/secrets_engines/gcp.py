...
class Gcp(VaultApiBase):
    ...
    async def rotate_roleset_account(self, name, mount_point=DEFAULT_MOUNT_POINT):
    ...
    async def rotate_roleset_account_key(self, name, mount_point=DEFAULT_MOUNT_POINT):
    ...
    async def read_roleset(self, name, mount_point=DEFAULT_MOUNT_POINT):
        """Read a roleset.
    ...
    async def list_rolesets(self, mount_point=DEFAULT_MOUNT_POINT):
    ...
    async def delete_roleset(self, name, mount_point=DEFAULT_MOUNT_POINT):
    ...
    async def generate_oauth2_access_token(self, roleset, mount_point=DEFAULT_MOUNT_POINT):
